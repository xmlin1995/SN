package com.SN.article.service;
...
import com.SN.article.dao.ArticleDao;
...
public class ArticleService {
	...
	public Article findById(String id) {
		...
		if(article==null){
			...
			redisTemplate.opsForValue().set("article_"+id,article,10,TimeUnit.SECONDS);//放入缓存并设置在缓存中保留的时间
